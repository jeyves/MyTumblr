...
//create a pre defined username add password since we do not have database
$acc_username = "Darwin";
$acc_password = "melaya";
$acc_fullname = "Jayvez Reyniel Santos";
$acc_address = "Isok 1 Boac, Marinduque";
//check the current url address for the redirections later
...
if(isset($_REQUEST['login_button']) === true){
	//get the username and password from the form and compare to the predefined username and password
		...
		//tama ang username  at password
			...
			header("Location: ".$url_add."?succes");
				...
				<div class="col-md-6 col-lg-5">
		      	...
		      	<h3 class="text-center mb-4">MyTumblr Login</h3>
		      		...
		      		<div class="form-group">
		      			...
		      			if(isset($_REQUEST['notexist'])===true){
		      			...
		      			}else if (isset($_REQUEST['succes']) === true){
		      						...
		      						echo "<div class='alert alert-info' role='alert'> Firts Log In First.</div>";
